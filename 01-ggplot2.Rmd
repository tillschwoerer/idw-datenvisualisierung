...
- **Datensatz** (data)
- **Ästhetik-Zuordnung** (aesthetic mapping): Welche Variable wird durch welche Ästhetik (x-Achse, y-Achse, Farbe, Größe, Form, ...) repräsentiert?
- **Objekttyp** (geometric object): z.B. Punkte, Linien, Balken, etc.
...
## Objekttyp (geometric object)


Grundsätzlich stehen Ihnen unterschiedliche Objekttypen zur Verfügung. Aber: Für eine gegebene Fragestellung kommen idR nur wenige davon konkret in Frage.

Welche Objekttypen sind für die folgende Fragestellung sinnvoll: *Wie stehen Fahrzeugalter und Preis miteinander in Beziehung?*
